...
class _$PokemonEntityImpl extends _PokemonEntity {
  _$PokemonEntityImpl({@HiveField(0) this.name, @HiveField(1) this.url})
      : super._();
  ...
  @override
  String toString() {
    return 'PokemonEntity(name: $name, url: $url)';
  }
...
abstract class _PokemonEntity extends PokemonEntity {
  factory _PokemonEntity(
      ...
      @HiveField(1) final String? url}) = _$PokemonEntityImpl;
  _PokemonEntity._() : super._();
